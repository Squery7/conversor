...
public class Temperatura extends VentanaBase {
    ...
    public Temperatura(String nombreVentana) {
        super(nombreVentana);
        this.ajustesPorDefecto();
    }

    public Temperatura(String nombreVentana, int tamX, int tamY, Menu m) {
    ...
    private void AgregarCheckInversor() {
        this.checkInversor.setText("Invertir Temp.");
                ...
                try {
                    ...
                    if (valor < - 491.67) {
                        JOptionPane.showMessageDialog(null,
                                "Error, solo se permite el ingreso de numeros mayores a -491.67!");
                    } else {
