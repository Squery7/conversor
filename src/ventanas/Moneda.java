...
public class Moneda extends VentanaBase {
    ...
    public Moneda(String nombreVentana) {
        super(nombreVentana);
        
        this.ajustesPorDefecto();
    }

    public Moneda(String nombreVentana, int tamX, int tamY, Menu m) {
    ...
    private void AgregarComboOpciones() {
        String[] opciones = {
                "Quetzales a Dolares",
                "Quetzales a Euros",
                "Quetzales a Libras Esterlinas",
                "Quetzales a Yen Japones",
                "Quetzales a Won sul-coreano",
        };
    ...
    private void AgregarCheckInversor() {
        this.checkInversor.setText("Invertir Moneda");
    ...
    private int tipoConversion(String s) {
        switch (s) {
            case "Quetzales a Dolares":
                return 1;
            case "Quetzales a Euros":
                return 2;
            case "Quetzales a Libras Esterlinas":
                return 3;
            case "Quetzales a Yen Japones":
                return 4;
            case "Quetzales a Won sul-coreano":
                return 5;
            default:
                return 0;
        }
